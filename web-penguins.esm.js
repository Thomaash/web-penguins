...
function lineLineIntersection(a, b) {
    const { point } = checkIntersection(a.start.x, a.start.y, a.end.x, a.end.y, b.start.x, b.start.y, b.end.x, b.end.y);
    return point
        ? {
            ...point,
...
export { CustomSpecimenType, PenguinZIndex, Species, WebPenguins, createDefaultSpecies, edgeToEdgeWalking, excavating, falling, ghostMoving, teleporting, waiting, walking };
//# sourceMappingURL=web-penguins.esm.js.map
